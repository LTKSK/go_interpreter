...
import (
	...
	"github.com/LTKSK/go_interpreter/monkey/token"
	"strconv"
)
...
func (p *Parser) parsePrefixExpression() ast.Expression {
	...
	// !か-を解釈したら次のtokenに進む。operatorの右はexpressionなので、
	// parseExpressionを使う
	p.nextToken()
...
func (p *Parser) noPrefixParseFnErorr(t token.TokenType) {
